      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Contact Us</a>
          </div>
            ...
            <div class="card">
              ...
              <form method="post" enctype="multipart/form-data">
                <table border="0" width="400px" height="300px" align="center" class="tableshadow">
                 <tr>
                      <td class="toptd"><h4>Contact Us</h4></td>
                    </tr>
                    <tr>
                      <td align="center" valign="top" style="padding-top:10px;">
                    <table border="0" align="center" width="95%">
                    <tr>
                      <td style="font-size:15px; padding:2px; font-weight:bold;">ContactId</td>
                      <td style="font-size:15px; padding:2px; font-weight:bold;">Name</td>
                      <td style="font-size:15px; padding:2px; font-weight:bold;">PhNo</td>
                      <td style="font-size:15px; padding:2px; font-weight:bold;">Email</td>
                      <td style="font-size:15px; padding:2px; font-weight:bold;">Message</td>
