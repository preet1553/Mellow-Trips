  ...
  <div class="wrapper ">
    ...
    <div class="main-panel" id="main-panel">
              ...
              <div class="card-header">
                <?php
                  if(isset($_POST["sbmt"]))
                  {
                    ...
                    $sql = "update users set pwd='" . $_POST["t2"] ."',Typeofuser='" . $_POST["s1"] . "' where Username='" . $_POST["t1"] . "'";
      ...
      ?>
        ...
        <tr><td class="lefttxt">Name</td><td><input type="text"  value='<?php if(isset($_POST["show"])){ echo $Username ;} ?>' name="t21" ></td></tr>
