      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="">View Package</a>
          </div>
                ...
                <table border="0" width="400px" height="300px" align="center" class="tableshadow">
                  <tr><td colspan="2" class="toptd"><h4>View Package</h4> </td></tr>
                    ...
                    echo "<tr>
                      ...
                      <td><IMG src='packimages/$data[5]' style='height:70PX;width:200px' /></td>
                      <td><IMG src='packimages/$data[6]' style='height:70PX;width:200px' /></td>
                      <td><IMG src='packimages/$data[7]' style='height:70PX;width:200px' /></td>
                    </tr>";
