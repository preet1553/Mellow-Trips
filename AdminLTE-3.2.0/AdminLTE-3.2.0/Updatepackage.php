        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="Addpackage.php">Home</a></li>
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="Addpackage.php" class="small-box-footer"> <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="Updatepackage.php" class="small-box-footer"> <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="Deletepackage.php" class="small-box-footer"> <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="Viewpackage.php" class="small-box-footer"> <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
                ...
                <div class="card">
                  ...
                  <?php include('function.php'); ?>
                    <?php
                        ...
                        //echo "t4 file name is " $_FILES["t4"]["name"];
                        ...
                        //echo "\nt5 file name is " $_FILES["t5"]["name"];
                        $uploadok = 1;
                        $imagefiletype = pathinfo($target_file, PATHINFO_EXTENSION);
                        ...
                        //echo "\nt6 file name is " $_FILES["t6"]["name"];
                        $uploadok = 1;
                        $imagefiletype = pathinfo($target_file, PATHINFO_EXTENSION);
                        //check file size
                    ...
                    <form method="post" enctype="multipart/form-data">
                        <table border="0" width="400px" height="300px" align="center" class="tableshadow">
                          <tr><td colspan="2" class="toptd"><h4>Update Package</h4></td></tr>
                        <tr><td class="lefttxt">Select Package</td><td><select name="s1" required/><option value="">Select</option>
                          ...
                          <tr><td class="lefttxt">Old Pic</td><td><img src="packimages/<?php echo @$Pic1; ?>" width="150px" height="70px" />
                          ...
                          <tr><td class="lefttxt">Old Pic</td><td><img src="packimages/<?php echo @$Pic2; ?>" width="150px" height="70px" />
                          ...
                          <tr><td class="lefttxt">Old Pic</td><td><img src="packimages/<?php echo @$Pic3; ?>" width="150px" height="70px" />
