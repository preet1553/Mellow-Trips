...
<title>Mellow Trips</title>
        <link rel="Main.jpg" sizes="76x76" href="./NewAdmin/assets/img/Main.jpg">
...
<tr><td class="middletext"><img src="Admin1/packimages/<?php echo $data[5];?>" width="200px" height="200px"  /></td>

<td class="middletext" style="padding-left:15px"><img src="Admin1/packimages/<?php echo $data[6];?>" width="200px" height="200px"  /></td>

<td class="middletext" style="padding-left:15px"><img src="Admin1/packimages/<?php echo $data[7];?>" width="200px" height="200px"  /></td>
</tr>
